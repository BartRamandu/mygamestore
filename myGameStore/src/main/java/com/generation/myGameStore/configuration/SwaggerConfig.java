package com.generation.myGameStore.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("com.generation.myGameStore.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/marianatheml")
			.contact(contact())
			.build();
	}
